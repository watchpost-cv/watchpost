...
var specs = []spec{
	...
	{"watchpost.cluster.propagation.kinds.list", "GET", "/api/v1/cluster/propagation/kinds", "cluster-propagation", "kinds", "internal/server/propagation_api.go", operation.Read, operation.Capability, "watchpost.role.viewer", operation.Automatable, true, true, nil},
	{"watchpost.cluster.propagation.export", "POST", "/api/v1/cluster/propagation/export", "cluster-propagation", "export", "internal/server/propagation_api.go", operation.Mutation, operation.Capability, "watchpost.role.admin", operation.Automatable, true, true, nil},
	{"watchpost.cluster.propagation.preview", "POST", "/api/v1/cluster/propagation/preview", "cluster-propagation", "preview", "internal/server/propagation_api.go", operation.Read, operation.Capability, "watchpost.role.admin", operation.Automatable, true, true, nil},
	{"watchpost.cluster.propagation.apply", "POST", "/api/v1/cluster/propagation/apply", "cluster-propagation", "apply", "internal/server/propagation_api.go", operation.Mutation, operation.Capability, "watchpost.role.admin", operation.Automatable, true, true, nil},
	{"watchpost.cluster.propagation.propagate", "POST", "/api/v1/cluster/propagation/propagate", "cluster-propagation", "propagate", "internal/server/propagation_api.go", operation.Mutation, operation.Capability, "watchpost.role.admin", operation.Automatable, true, true, nil},
	{"watchpost.cluster.propagation.history.list", "GET", "/api/v1/cluster/propagation/history", "cluster-propagation-history", "list", "internal/server/propagation_api.go", operation.Read, operation.Capability, "watchpost.role.viewer", operation.Automatable, true, true, nil},
	{"watchpost.cluster.propagation.profiles.list", "GET", "/api/v1/cluster/propagation/profiles", "cluster-propagation-profiles", "list", "internal/server/propagation_api.go", operation.Read, operation.Capability, "watchpost.role.viewer", operation.Automatable, true, true, nil},
	{"watchpost.cluster.propagation.profiles.update", "PUT", "/api/v1/cluster/propagation/profiles/{id}", "cluster-propagation-profiles", "update", "internal/server/propagation_api.go", operation.Mutation, operation.Capability, "watchpost.role.admin", operation.Automatable, true, true, nil},
	{"watchpost.cluster.propagation.profiles.delete", "DELETE", "/api/v1/cluster/propagation/profiles/{id}", "cluster-propagation-profiles", "delete", "internal/server/propagation_api.go", operation.Destructive, operation.Capability, "watchpost.role.admin", operation.Automatable, true, true, nil},
	{"watchpost.cluster.propagation.profiles.run-due", "POST", "/api/v1/cluster/propagation/profiles/run-due", "cluster-propagation-profiles", "run-due", "internal/server/propagation_api.go", operation.Mutation, operation.Capability, "watchpost.role.admin", operation.Automatable, true, true, nil},
	{"watchpost.cluster.propagation.rpc.preview", "POST", "/api/cluster/v1/rpc/propagation/preview", "cluster-propagation-rpc", "preview", "internal/server/propagation_api.go", operation.Read, operation.Service, "", operation.ServiceProtocol, false, false, nil},
	{"watchpost.cluster.propagation.rpc.apply", "POST", "/api/cluster/v1/rpc/propagation/apply", "cluster-propagation-rpc", "apply", "internal/server/propagation_api.go", operation.Mutation, operation.Service, "", operation.ServiceProtocol, false, false, nil},
